...
namespace WebApi2Book.Web.Api.Tests.InquiryProcessing
{
    ...
    public class AllTasksInquiryProcessorTest
    {
        ...
        public void SetUp()
        {
            ...
            _inquiryProcessor = new AllTasksInquiryProcessorTestDouble(
                _allTasksQueryProcessorMock.Object, _autoMapperMock.Object, _taskLinkServiceMock.Object,
                _commonLinkServiceMock.Object);
        }
        ...
        private class AllTasksInquiryProcessorTestDouble : AllTasksInquiryProcessor
        {
            public AllTasksInquiryProcessorTestDouble(IAllTasksQueryProcessor queryProcessor,
                IAutoMapper autoMapper, ITaskLinkService taskLinkService,
            ...
            public Action<PagedTaskDataInquiryResponse>
                AddLinksToInquiryResponseTestDouble { get; set; }
            ...
            {
                return GetTasksTestDouble == null
                    ? base.GetTasks(taskEntities)
                    : GetTasksTestDouble(taskEntities);
            }
            ...
            public override string GetCurrentPageQueryString(
                PagedTaskDataInquiryResponse inquiryResponse)
            {
            ...
            public override string GetNextPageQueryString(PagedTaskDataInquiryResponse
                inquiryResponse)
            {
        ...
        public void AddLinksToInquiryResponse_adds_page_links()
        {
            ...
            _inquiryProcessor.GetPreviousPageQueryStringTestDouble =
                response => previousPageQueryString;
            _inquiryProcessor.GetNextPageQueryStringTestDouble = response => nextPageQueryString;

            _inquiryProcessor.AddLinksToInquiryResponse(inquiryResponse);
            _commonLinkServiceMock.Verify(
                x =>
                    x.AddPageLinks(inquiryResponse, currentPageQueryString,
        ...
        public void GetTasks_adds_child_links()
        {
            ...
            {
                var index = i;
                _autoMapperMock.Setup(x => x.Map<Models.Task>(taskEntities[index])).
                    Returns(tasks[index]);
                _taskLinkServiceMock.Setup(x => x.AddLinksToChildObjects(tasks[index])).
                    Verifiable();
            }
        ...
        public void GetTasks_returns_correct_result()
        {
            ...
            Assert.AreEqual(queryResult.TotalPageCount, actualResult.PageCount,
                "Incorrect PageCount in result");
